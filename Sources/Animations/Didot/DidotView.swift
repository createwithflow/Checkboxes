...
public class DidotView: UIView {
    ...
    private func createBorder() {
        ...
        border.shapeLayer.strokeColor = UIColor(red: 0, green: 0, blue: 1, alpha: 1).cgColor
    ...
    private func createCheckShort() {
        checkShort = ShapeView(frame: CGRect(x: 10, y: 16.5, width: 4, height: 4))
        checkShort.backgroundColor = UIColor.clear
        checkShort.layer.anchorPoint = CGPoint(x: 0, y: 0)
        checkShort.alpha = 0
        ...
        checkShort.layer.position = CGPoint(x: 10, y: 16.5)
        ...
        checkShort.shapeLayer.strokeColor = UIColor(red: 0, green: 0, blue: 1, alpha: 1).cgColor
    ...
    private func createCheckLong() {
        ...
        checkLong.layer.position = CGPoint(x: 14, y: 12)
        ...
        checkLong.shapeLayer.strokeColor = UIColor(red: 0, green: 0, blue: 1, alpha: 1).cgColor
