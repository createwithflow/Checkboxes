...
public class PrimeView: UIView {
    ...
    private func createCheck() {
        check = ShapeView(frame: CGRect(x: 7, y: 9, width: 12.5, height: 8.5))
        ...
        check.shapeLayer.strokeColor = UIColor(red: 0, green: 0.482, blue: 1, alpha: 1).cgColor
