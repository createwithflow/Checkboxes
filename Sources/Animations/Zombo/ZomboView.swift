...
public class ZomboView: UIView {
    ...
    private func createCheckLeft() {
        checkLeft = ShapeView(frame: CGRect(x: 6, y: 13, width: 5, height: 13))
        ...
        checkLeft.layer.position = CGPoint(x: 6, y: 13)
        checkLeft.layer.bounds = CGRect(x: 0, y: 0, width: 5, height: 13)
        checkLeft.layer.masksToBounds = false
        checkLeft.shapeLayer.fillRule = CAShapeLayerFillRule.evenOdd
        checkLeft.shapeLayer.strokeColor = UIColor(red: 0.765, green: 0.769, blue: 0.773, alpha: 1).cgColor
        ...
        checkLeft.shapeLayer.strokeStart = 1
        ...
        checkLeft.shapeLayer.path = CGPathCreateWithSVGString("M0,0l5,5 0,8")!

    }

    private func createCheckRight() {
        checkRight = ShapeView(frame: CGRect(x: 11, y: 8, width: 10, height: 18))
        ...
        checkRight.layer.position = CGPoint(x: 11, y: 8)
        checkRight.layer.bounds = CGRect(x: 0, y: 0, width: 10, height: 18)
        checkRight.layer.masksToBounds = false
        checkRight.shapeLayer.fillRule = CAShapeLayerFillRule.evenOdd
        checkRight.shapeLayer.strokeColor = UIColor(red: 0.765, green: 0.769, blue: 0.773, alpha: 1).cgColor
        ...
        checkRight.shapeLayer.strokeStart = 1
        ...
        checkRight.shapeLayer.path = CGPathCreateWithSVGString("M10,0l-10,10 0,8")!
