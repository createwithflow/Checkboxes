...
public class PopView: UIView {
    ...
    private func createCircleBackground() {
        ...
        circleBackground.shapeLayer.strokeColor = UIColor(red: 0.498, green: 0.004, blue: 0.733, alpha: 1).cgColor
        circleBackground.shapeLayer.fillColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0).cgColor
        ...
        circleBackground.shapeLayer.lineWidth = 0.25
    ...
    private func createPop() {
        pop = ShapeView(frame: CGRect(x: 26, y: 6, width: 20, height: 20))
        pop.backgroundColor = UIColor.clear
        pop.layer.anchorPoint = CGPoint(x: 0, y: 0)
        pop.alpha = 0
        pop.transform = CGAffineTransform(rotationAngle: -1 * CGFloat.pi)
        pop.transform = pop.transform.scaledBy(x: 1, y: -1)
        pop.layer.shadowOffset = CGSize(width: 0, height: 0)
        pop.layer.borderColor = UIColor.clear.cgColor
        pop.layer.shadowColor = UIColor.clear.cgColor
        pop.layer.shadowOpacity = 1
        pop.layer.position = CGPoint(x: 26, y: 6)
        pop.layer.bounds = CGRect(x: 0, y: 0, width: 20, height: 20)
        pop.layer.masksToBounds = false
        pop.shapeLayer.fillRule = CAShapeLayerFillRule.evenOdd
        pop.shapeLayer.fillColor = UIColor(red: 0.498, green: 0.004, blue: 0.733, alpha: 1).cgColor
        pop.shapeLayer.lineCap = CAShapeLayerLineCap(rawValue: "round")
        pop.shapeLayer.lineJoin = CAShapeLayerLineJoin(rawValue: "round")
        pop.shapeLayer.miterLimit = 4
        pop.shapeLayer.lineDashPattern = []
        pop.shapeLayer.lineDashPhase = 0
        pop.shapeLayer.lineWidth = 0
        pop.shapeLayer.path = CGPathCreateWithSVGString("M10,20c5.5,0,10,-4.5,10,-10 0,-5.5,-4.5,-10,-10,-10 -5.5,0,-10,4.5,-10,10 0,5.5,4.5,10,10,10zM10,20")!
    ...
    private func createCircleForeground() {
        ...
        circleForeground.shapeLayer.fillColor = UIColor(red: 0.498, green: 0.004, blue: 0.733, alpha: 1).cgColor
